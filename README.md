...
## Publications
- [Think in Strokes, Not Pixels: Process-driven Image Generation via Interleaved Reasoning](https://yusalei.github.io). 
...
- [Audio-Visual LLM for Video Understanding](https://arxiv.org/pdf/2312.06720.pdf).
<br>Fangxun Shu\*, **Lei Zhang\***, Hao Jiang, Cihang Xie.
<br>Technical Report.

- [Filter & Align: Leveraging Human Knowledge to Curate Image-Text Data](https://arxiv.org/pdf/2312.06726.pdf).
<br>**Lei Zhang**, Fangxun Shu, Tianyang Liu, Sucheng Ren, Hao Jiang, Cihang Xie.
<br>Technical Report.
...
<br>**Lei Zhang**, Zhibo Wang, Xiaowei Dong, Yunhe Feng, Xiaoyi Pang, Zhifei Zhang, Kui Ren.
<br>ICCV 2023.

- [Accelerating Dataset Distillation via Model Augmentation](https://openaccess.thecvf.com/content/CVPR2023/papers/Zhang_Accelerating_Dataset_Distillation_via_Model_Augmentation_CVPR_2023_paper.pdf).
<br>**Lei Zhang**, Jie Zhang, Bowen Lei, Subhabrata Mukherjee, Xiang Pan, Bo Zhao, Caiwen Ding, Li Yao, Dongkuan Xu.
